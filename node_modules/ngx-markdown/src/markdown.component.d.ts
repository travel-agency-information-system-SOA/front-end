...
export declare class MarkdownComponent implements OnChanges, AfterViewInit, OnDestroy {
    ...
    get srcRelativeLink(): boolean;
    set srcRelativeLink(value: boolean);
